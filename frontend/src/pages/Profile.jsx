      ...
      <div className="max-w-screen-xl mx-auto flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-12 gap-x-16">
          ...
          <section className="mt-6 sm:mt-0">
            ...
            <div className="mt-6">
              <Typography variant="body1" sx={{ color: '#d1d5db', fontWeight: 500 }}>
        ...
        <div className="border-t border-gray-700 mt-12 w-full">
          <div className="flex justify-center gap-12 text-lg">
            {['posts', 'saved'].map((tab) => (
              <Typography
                key={tab}
                className={`py-4 cursor-pointer ${activeTab === tab ? 'text-blue-400 font-bold border-b-2 border-blue-400' : 'text-gray-400 hover:text-gray-200'}`}
